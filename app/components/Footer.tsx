...
const Footer = () => {
    return (
        <section className="relative overflow-hidde py-8 h-[20dvh] flex flex-col items-center justify-center bg-blue-50">
                ...
                <div className="-m-8 flex flex-wrap items-center justify-between">
                    ...
                    <div className="w-auto p-8">
                        <ul className="-m-5 flex flex-wrap items-center">
                            <li className="p-5">
                                <Link className="font-medium text-gray-600 hover:text-gray-700" href="/about">
                                    About Us
                                </Link>
                            </li>
                            <li className="p-5">
